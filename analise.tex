...
\begin{definicao}[$\overset{R}{\sim}$]
	Dado uma relação entre $A$ e $B$, dizemos que $a\in A$ está relacionado a $b\in B$ se $(a,b) \in R$. Escrevemos nesse caso $a\overset{R}{\sim}  b$, ou $aRb$. Portanto:
	$$ a\overset{R}{\sim} b \iff aRb \iff  (a,b) \in R$$
\end{definicao}
\begin{obs}
...
\begin{definicao}[Relação de equivalência]
	...
	\end{itemize}
\end{definicao}
\begin{definicao}[Relação de Ordem]
	%carro
\end{definicao}
