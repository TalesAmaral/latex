...
\begin{definicao}[Conjunto limitado]
	Um conjunto $X\subset \mathbb{N}$ é limitado quando existe $p\in \mathbb{N}$ tal que $\forall n\in \mathbb{X} \: : \: n \leq p$.
\end{definicao}
...
\begin{teo}
	Seja $X\subset \mathbb{N}$. As seguintes afirmações são equivalentes:
	\begin{itemize}
		\item $X$ é finito.
		\item $X$ é limitado.
