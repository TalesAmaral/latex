...
\end{proof}
\begin{definicao}
	Dados \(A,B\) quaisquer, o conjunto \(C\) tal que \(D\in C \iff D = A \land D = B\) existe e é único pelo axioma da extensão. O denotaremos por \[ \{ A,B\}. \]
...
\begin{axioma}[Axioma da União]
	Para todo conjunto \( A\), existe um conjunto \(U\) tal que \( \forall D ( (D\in B \land B\in A) \implies D \in U) \).
	\[ \forall A \: : \:  \exists U  \: : \: \forall D  \: : \: ( (D \in B \land B\in A) \implies D\in U ) \]
\end{axioma}
\begin{prop}
	Dado \( A\), existe um conjunto \(U\) tal que \( \forall D ( (D\in B \land B\in A) \implies D \in U) \) se, e somente se, existe um conjunto \(U\) tal que \( \forall D ( (D\in B \land B\in A) \iff D \in U) \).
\end{prop}
\begin{proof}
Se existe um conjunto \(U\) tal que \( \forall D ( (D\in B \land B\in A) \iff D \in U) \), então existe um conjunto \(U\) tal que \( \forall D ( (D\in B \land B\in A) \implies D \in U) \).
	Se existe um conjunto \(U\) tal que \( \forall D ( (D\in B \land B\in A) \implies D \in U) \), então tomando \( U' = \{ D\in U \: | \: D\in B \land D \in A\} \) conclui a demonstração.
\end{proof}
